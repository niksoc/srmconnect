import re
from django.forms.widgets import Widget, SelectDateWidget, Select, MultiWidget
from django.utils.safestring import mark_safe

'''
credit to bradmontgomery
https://www.djangosnippets.org/snippets/1202/
and https://www.djangosnippets.org/snippets/1206/
for SelectTimeWidget and SplitSelectDateTimeWidget
'''
...
class SplitSelectDateTimeWidget(MultiWidget):
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=None, years=None):
        ...
        widgets = (SelectDateWidget(attrs=attrs, years=years), SelectTimeWidget(
            attrs=attrs, hour_step=hour_step, minute_step=minute_step, second_step=second_step, twelve_hr=twelve_hr))
    ...
    def format_output(self, rendered_widgets):
        ...
        """
        return u' H:M:S '.join(rendered_widgets)
